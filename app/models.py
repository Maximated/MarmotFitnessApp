...
class ExerciseRating(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "exercise_id", name="uq_exercise_rating_user_exercise"),
    )
...
class ExerciseUserProgress(Base):
    __tablename__ = "exercise_user_progress"
    __table_args__ = (
        UniqueConstraint("user_id", "exercise_id", name="uq_exercise_user_progress_user_exercise"),
    )
